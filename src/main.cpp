 ...
 */
 ...
 // speaker_mp3.h removed - MP3 functionality disabled
 ...
 static bool initializeHardware() {
   ...
   // Initialize power module right after I2C
   if (initializePowerModule()) {
     ESP_LOGI("BYTE-90", "Power module initialized successfully");
     // Print initial power status for debugging
     printPowerSystemStatus();
     
   } else {
     ESP_LOGW("BYTE-90", "Power module initialization skipped (not present)");
   }
