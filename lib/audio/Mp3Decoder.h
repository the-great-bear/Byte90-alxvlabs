...
// prototypes
    /**
     * @brief M p3 decoder_ allocate buffers
     *
     * @return true on success, false on failure
     */
bool MP3Decoder_AllocateBuffers(void);
    /**
     * @brief M p3 decoder_ is init
     *
     * @return true on success, false on failure
     */
bool MP3Decoder_IsInit();
    /**
     * @brief M p3 decoder_ free buffers
     */
void MP3Decoder_FreeBuffers();
    /**
     * @brief M p3 decode
     *
     * @param inbuf Pointer to inbuf
     * @param bytesLeft Pointer to bytesLeft
     * @param outbuf Output parameter
     * @param useSize Numeric value
     *
     * @return Result value
     */
int32_t  MP3Decode( uint8_t *inbuf, int32_t *bytesLeft, int16_t *outbuf, int32_t useSize);
    /**
     * @brief M p3 get last frame info
     */
void     MP3GetLastFrameInfo();
    /**
     * @brief M p3 get next frame info
     *
...
int32_t  MP3GetNextFrameInfo(uint8_t *buf);
    /**
     * @brief M p3 find sync word
     *
     * @param buf Pointer to buf
     * @param nBytes Numeric value
     *
     * @return Result value
     */
int32_t  MP3FindSyncWord(uint8_t *buf, int32_t nBytes);
    /**
     * @brief M p3 get samp rate
     *
     * @return Result value
     */
int32_t  MP3GetSampRate();
    /**
     * @brief M p3 get channels
     *
     * @return Result value
     */
int32_t  MP3GetChannels();
    /**
     * @brief M p3 get bits per sample
     *
     * @return Result value
     */
int32_t  MP3GetBitsPerSample();
    /**
     * @brief M p3 get bitrate
     *
     * @return Result value
     */
int32_t  MP3GetBitrate();
    /**
     * @brief M p3 get output samps
     *
     * @return Result value
     */
int32_t  MP3GetOutputSamps();
    /**
     * @brief M p3 get layer
     *
     * @return Result value
     */
int32_t  MP3GetLayer();
    /**
     * @brief M p3 get version
     *
     * @return Result value
     */
...
//internally used
    /**
     * @brief M p3 decoder_ clear buffer
     */
void MP3Decoder_ClearBuffer(void);
    /**
     * @brief Polyphase mono
     *
     * @param pcm Output parameter
     * @param vbuf Pointer to vbuf
     * @param coefBase Pointer to coefBase
     */
void PolyphaseMono(int16_t *pcm, int32_t *vbuf, const uint32_t* coefBase);
    /**
     * @brief Polyphase stereo
     *
     * @param pcm Output parameter
     * @param vbuf Pointer to vbuf
     * @param coefBase Pointer to coefBase
...
void PolyphaseStereo(int16_t *pcm, int32_t *vbuf, const uint32_t* coefBase);
    /**
     * @brief Set bitstream pointer
     *
     * @param bsi Pointer to bsi
     * @param nBytes Numeric value
     * @param buf Pointer to buf
     */
void SetBitstreamPointer(BitStreamInfo_t *bsi, int32_t nBytes, uint8_t *buf);
     ...
     *
     * @param bsi Pointer to bsi
     * @param nBits Numeric value
     *
     * @return Result value
     */
uint32_t GetBits(BitStreamInfo_t *bsi, int32_t nBits);
    /**
     * @brief Calc bits used
     *
     * @param bsi Pointer to bsi
     * @param startBuf Pointer to startBuf
     * @param startOffset Numeric value
     *
     * @return Result value
     */
int32_t CalcBitsUsed(BitStreamInfo_t *bsi, uint8_t *startBuf, int32_t startOffset);
    /**
     * @brief Dequant channel
     *
     * @param sampleBuf Pointer to sampleBuf
     * @param workBuf Pointer to workBuf
     * @param nonZeroBound Pointer to nonZeroBound
     * @param sis Pointer to sis
     * @param sfis Pointer to sfis
     * @param cbi Pointer to cbi
     *
     * @return Result value
     */
int32_t DequantChannel(int32_t *sampleBuf, int32_t *workBuf, int32_t *nonZeroBound, SideInfoSub_t *sis, ScaleFactorInfoSub_t *sfis, CriticalBandInfo_t *cbi);
     ...
     * @brief Mid side proc
     *
     * @param nSamps Numeric value
     */
void MidSideProc(int32_t x[m_MAX_NCHAN][m_MAX_NSAMP], int32_t nSamps, int32_t mOut[2]);
    /**
     * @brief Intensity proc m p e g1
     *
     * @param nSamps Numeric value
     * @param sfis Pointer to sfis
     * @param cbi Pointer to cbi
     * @param midSideFlag Identifier
     * @param mixFlag Numeric value
     */
void IntensityProcMPEG1(int32_t x[m_MAX_NCHAN][m_MAX_NSAMP], int32_t nSamps, ScaleFactorInfoSub_t *sfis,	CriticalBandInfo_t *cbi, int32_t midSideFlag, int32_t mixFlag, int32_t mOut[2]);
    /**
     * @brief Intensity proc m p e g2
     *
     * @param nSamps Numeric value
     * @param sfis Pointer to sfis
     * @param cbi Pointer to cbi
     * @param sfjs Pointer to sfjs
     * @param midSideFlag Identifier
     * @param mixFlag Numeric value
     */
void IntensityProcMPEG2(int32_t x[m_MAX_NCHAN][m_MAX_NSAMP], int32_t nSamps, ScaleFactorInfoSub_t *sfis, CriticalBandInfo_t *cbi, ScaleFactorJS_t *sfjs, int32_t midSideFlag, int32_t mixFlag, int32_t mOut[2]);
     ...
     * @param oddBlock Numeric value
     * @param gb Numeric value
     */
...
int32_t UnpackSideInfo(uint8_t *buf);
    /**
     * @brief Decode huffman
     *
     * @param buf Pointer to buf
     * @param bitOffset Pointer to bitOffset
     * @param huffBlockBits Numeric value
     * @param gr Numeric value
     * @param ch Numeric value
     *
     * @return Result value
     */
int32_t DecodeHuffman( uint8_t *buf, int32_t *bitOffset, int32_t huffBlockBits, int32_t gr, int32_t ch);
    /**
     * @brief M p3 dequantize
     *
     * @param gr Numeric value
     *
     * @return Result value
...
int32_t IMDCT( int32_t gr, int32_t ch);
    /**
     * @brief Unpack scale factors
     *
     * @param buf Pointer to buf
     * @param bitOffset Pointer to bitOffset
     * @param bitsAvail Numeric value
     * @param gr Numeric value
     * @param ch Numeric value
     *
     * @return Result value
...
int32_t Subband(int16_t *pcmBuf);
     ...
     * @param fracBits Numeric value
     *
     * @return Result value
     */
int16_t ClipToShort(int32_t x, int32_t fracBits);
    /**
     * @brief Refill bitstream cache
     *
     * @param bsi Pointer to bsi
     */
void RefillBitstreamCache(BitStreamInfo_t *bsi);
    /**
     * @brief Unpack s f m p e g1
     *
     * @param bsi Pointer to bsi
     * @param sis Pointer to sis
     * @param sfis Pointer to sfis
     * @param scfsi Pointer to scfsi
     * @param gr Numeric value
     * @param sfisGr0 Pointer to sfisGr0
     */
...
int32_t MP3FindFreeSync(uint8_t *buf, uint8_t firstFH[4], int32_t nBytes);
    /**
     * @brief M p3 clear bad frame
     *
     * @param outbuf Output parameter
     */
void MP3ClearBadFrame( int16_t *outbuf);
    /**
     * @brief Decode huffman pairs
     *
     * @param xy Pointer to xy
     * @param nVals Numeric value
     * @param tabIdx Identifier
     * @param bitsLeft Numeric value
     * @param buf Pointer to buf
     * @param bitOffset Numeric value
     *
     * @return Result value
     */
int32_t DecodeHuffmanPairs(int32_t *xy, int32_t nVals, int32_t tabIdx, int32_t bitsLeft, uint8_t *buf, int32_t bitOffset);
    /**
     * @brief Decode huffman quads
     *
     * @param vwxy Pointer to vwxy
     * @param nVals Numeric value
     * @param tabIdx Identifier
     * @param bitsLeft Numeric value
     * @param buf Pointer to buf
...
int32_t DequantBlock(int32_t *inbuf, int32_t *outbuf, int32_t num, int32_t scale);
     ...
     *
     * @param x Pointer to x
     * @param nBfly Numeric value
     */
void AntiAlias(int32_t *x, int32_t nBfly);
    /**
     * @brief Win previous
     *
     * @param xPrev Pointer to xPrev
     * @param xPrevWin Pointer to xPrevWin
     * @param btPrev Numeric value
     */
void WinPrevious(int32_t *xPrev, int32_t *xPrevWin, int32_t btPrev);
    /**
     * @brief Freq invert rescale
     *
     * @param y Pointer to y
     * @param xPrev Pointer to xPrev
     * @param blockIdx Identifier
     * @param es Numeric value
     *
     * @return Result value
     */
...
void idct9(int32_t *x);
     ...
     * @brief I m d c t36
     *
     * @param xCurr Pointer to xCurr
     * @param xPrev Pointer to xPrev
     * @param y Pointer to y
     * @param btCurr Numeric value
     * @param btPrev Numeric value
     * @param blockIdx Identifier
     * @param gb Numeric value
     *
